...
add_library(knn_swig "")

target_sources(knn_swig
  PRIVATE
    include/knn_swig.hpp
    src/knn_swig.cpp)
target_include_directories(knn_swig
  PUBLIC
    $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/include>
    $<INSTALL_INTERFACE:include>)
target_compile_features(knn_swig PUBLIC cxx_std_11)
set_target_properties(knn_swig PROPERTIES
  VERSION ${PROJECT_VERSION}
  PUBLIC_HEADER include/knn_swig.hpp)
...
install(TARGETS knn_swig
  # EXPORT ${PROJECT_NAME}Targets
  EXPORT knn_swigTargets
...
# Install
install(EXPORT knn_swigTargets
  #NAMESPACE CMakeSwig::
